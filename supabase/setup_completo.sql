...
--
-- ⚠️ ANTES DE CORRER, revisa 1 cosa (opcional):
--   • "Samuel Garzón"  → si el árbitro de Cancha 3/Final se llama distinto,
--     cámbialo. Si no estás seguro, déjalo y se corrige después.
--   (Las cuentas de staff, como la de Simón, se crean desde la app, no aquí.)
-- ════════════════════════════════════════════════════════════════════
...
--
-- Para darle a Simón una cuenta de SUPERVISOR, ver las instrucciones que
-- te pasé en el chat (crear la cuenta con rol SUPERVISOR desde el panel).
...
-- ####################################################################
-- # PARTE 5 · MEJORAS FINALES (auditoría, tMt, deuda por equipo)
-- ####################################################################
-- ════════════════════════════════════════════════════════════════════
